...
class Layout_Main{
	...
	*/
	...
	/*
		Layout_Main::do_features()
		@desc Creates the features
		@return <section> ... </section>
	*/
	public static function do_features(){
		$s = View::forge('components/features');
		return $s;
	}

	/*
		Layout_Main::do_info()
		@desc Creates the info
		@return <section> ... </section>
	*/
	public static function do_info(){
		$t = View::forge('components/info');
		return $t;
	}

	/*
		Layout_Main::do_latest_news()
		@desc Creates the latest news
		@return <section> ... </section>
	*/
	public static function do_latest_news(){
		$u = View::forge('components/latest_news');
		return $u;
	}

	/*
		Layout_Main::do_overview()
		@desc Creates the overview
		@return <section> ... </section>
	*/
	public static function do_overview(){
		$v = View::forge('components/overview');
		return $v;
	}

	/*
		Layout_Main::do_services()
		@desc Creates the services
		@return <section> ... </section>
	*/
	public static function do_services(){
		$w = View::forge('components/services');
		return $w;
	}

	/*
		Layout_Main::do_slideshow()
		@desc Creates the slide show
		@return <section> ... </section>
	*/
	public static function do_slideshow(){
		$x = View::forge('components/slideshow');
		return $x;
	}

	/*
		Layout_Main::do_steps()
		@desc Creates the steps
		@return <section> ... </section>
	*/
	public static function do_steps(){
		$y = View::forge('components/steps');
		return $y;
	}

	/*
		Layout_Main::do_footer()
		@desc Creates the footer
		@return <footer> ... </footer>
	*/
	public static function do_footer(){
		$z = View::forge('components/footer');
		return $z;
	}
