<?php if(isset($bundle)): ?>
	...
	<?php $bundle->start(); ?>
		...
		<script type="text/javascript" src="/assets/js/pages/services.js"></script>
		<!-- // -->
		...
		<link media="screen" type="text/css" href="/assets/css/pages/services.css">
	<?php $bundle->end(); ?>
    ...
    <section class="w3l-service-breadcrum">
                ...
                <div class="features py-5" id="services">
                    <div class="container py-md-3">
                        <div class="heading text-center mx-auto">
                            <h3 class="head">Market your business</h3>
                    ...
                    <div class="fea-gd-vv text-center row mt-5 pt-3">
                            ...
                            <div class="float-top col-lg-4 col-md-6">	
                                    ...
                                    <div class="float-lt feature-gd">	
                                            <h3><a href="#">Quality Coordinator</a> </h3>
                            ...
                            <div class="float-top col-lg-4 col-md-6 mt-md-0 mt-5">	
                                    ...
                                    <div class="float-lt feature-gd">	
                                        <h3><a href="#">Insurance Invest</a> </h3>
                                        <p> Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;
                                            Nulla mollis dapibus</p>
                                            <a href="#" class="red mt-3">Read More <span class="fa fa-angle-right pl-1"></span></a>
                                            </div>
                                ...
                                <div class="float-top col-lg-4 col-md-6 mt-lg-0 mt-5">	
                                        ...
                                        <div class="float-lt feature-gd">	
                                            <h3><a href="#">Financing Management</a> </h3>
                                            <p> Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;
                                                Nulla mollis dapibus</p>
                                                <a href="#" class="red mt-3">Read More <span class="fa fa-angle-right pl-1"></span></a>
                                            </div>
        ...
        <section class="w3l-mobile-content-6 bg-white">
            <div class="mobile-info py-5">
                ...
                <div class="container py-md-3">
                    <div class="heading text-center mx-auto">
                        <h3 class="head">Services Overview</h3>
                        <p class="my-3 head"> Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;
                        Nulla mollis dapibus nunc, ut rhoncus
                        turpis sodales quis. Integer sit amet mattis quam.</p>
                    ...
                    <div class="row mobile-info-inn mt-5 pt-3">
                        <div class="col-lg-6 image-left">
                            <div class="row mobile-right-grids mb-lg-5 mb-4">
                                <div class="col-2 mobile-right-icon">
                                    <div class="mobile-icon text-right">
                                        <span class="fa fa-area-chart"></span>
                                    </div>
                                </div>
                                <div class="col-10 mobile-right-info">
                                    <h6><a href="#url">Finance</a></h6>
                        ...
                        <div class="col-lg-6 mobile-right mt-lg-0 mt-5">
                            <div class="row mobile-right-grids mb-lg-5 mb-4">
                                ...
                                <div class="col-10 mobile-right-info">
                                    <h6><a href="#url">Administration</a></h6>
                                    <p>Lorem ipsum dolor sit amet,Ea sed illum facere aperiam sequi optio consectetur
                                        adipisicing elit.</p>
                                </div>
                            </div>
                            <div class="row mobile-right-grids mb-lg-5 mb-4">
                                ...
                                <div class="col-10 mobile-right-info">
                                    <h6><a href="#url">Information</a></h6>
                                    <p>Lorem ipsum dolor sit amet,Ea sed illum facere aperiam sequi optio consectetur
                                        adipisicing elit.</p>
                                </div>
                            </div>
        ...
        <!-- services page block 3 -->
        <section class="w3l-mobile-content-7">
            <div class="mobile-info py-5">
                <!-- /mobile-info-->
                <div class="container py-md-3">
                    <div class="heading text-center mx-auto">
                        <h3 class="head">Trading & Stocking</h3>
                        <p class="my-3 head"> Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;
                        Nulla mollis dapibus nunc, ut rhoncus
                        turpis sodales quis. Integer sit amet mattis quam.</p>
                    ...
                    <div class="row mobile-info-inn mt-5 pt-3">
                        ...
                        <div class="col-lg-6 mobile-right mt-lg-0 mt-5">
                            <div class="row mobile-right-grids mb-lg-5 mb-4">
                                ...
                                <div class="col-10 mobile-right-info">
                                    <h6><a href="#url">Performance Consultants</a></h6>
                                    <p>Lorem ipsum dolor sit amet,Ea sed illum facere aperiam sequi optio consectetur
                                        adipisicing elit.</p>
                                </div>
                            </div>
                            <div class="row mobile-right-grids mb-lg-5 mb-4">
                                ...
                                <div class="col-10 mobile-right-info">
                                    <h6><a href="#url">Business Transformation</a></h6>
                                    <p>Lorem ipsum dolor sit amet,Ea sed illum facere aperiam sequi optio consectetur
                                        adipisicing elit.</p>
                                </div>
                            </div>
                            <div class="row mobile-right-grids">
                                ...
                                <div class="col-10 mobile-right-info">
                                    <h6><a href="#url">Professional Consulting</a></h6>
                                    <p>Lorem ipsum dolor sit amet,Ea sed illum facere aperiam sequi optio consectetur
                                        adipisicing elit.</p>
                                </div>
                            </div>
